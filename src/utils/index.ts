export function treeToList(tree: any[] = [], idValue = null, childrenField = 'children', idField = 'id', parentIdField = 'parentId') {
  const list = []
...
export function listToTree(list: any[] = [], root = null, idField = 'id', parentIdField = 'parentId') {
  const tree = []
  const hash = {}
